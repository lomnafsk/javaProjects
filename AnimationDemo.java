...
public class AnimationDemo extends JFrame{
    public AnimationDemo() {
        // Create tow MovingMessgaePanel for displaying tow moving messages
        this.setLayout(new GridLayout(2, 1));
        add(new MovableMessagePanel("message 1 moving?"));
        add(new MovableMessagePanel("message 2 moving?"));
    }
