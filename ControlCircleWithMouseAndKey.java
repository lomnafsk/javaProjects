package controlcirclewithmouseandkey;
import java.awt.*;
...
public class ControlCircleWithMouseAndKey extends JFrame {
    ...
    public ControlCircleWithMouseAndKey() {
        JPanel panel = new JPanel(); // Use the panel to group buutons
        panel.add(jbtEnlarge);
        panel.add(jbtShrink);
         this.add(canvas, BorderLayout.CENTER); // Add canvas to center
         this.add(panel, BorderLayout.SOUTH); // Add the buttons to the frame
